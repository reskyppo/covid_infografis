...
const Prevention = () => {
  return (
    <div className="flex md:ml-32">
      <img src={reminder} alt="reminder" className="w-1/3" />
      <div className=" w-2/3  flex">
        <section className="flex-col flex items-center text-center">
          ...
          <div className="flex w-full pt-8">
            <div className="flex-row w-1/2 justify-center">
              <h1 className="text-2xl font-bold">
                What you <span className="text-green-500">should do.</span>
              </h1>
              <div className="flex-row text-left text-2xl py-4 px-4 pl-12">
                <p>
                  <span className="text-green-500 text-3xl">•</span> Reduce your
                  stress.
                </p>
                <p>
                  <span className="text-green-500 text-3xl">•</span> Speaking of
                ...
                <p>
                  <span className="text-green-500 text-3xl">•</span> Cough into
                  your sleeve or a tissue, not your hands.
                </p>
                <p>
                  <span className="text-green-500 text-3xl">•</span> Buy a
            ...
            <div className="flex-row w-1/2 justify-center">
              ...
              <div className="flex-row text-left text-2xl py-4 px-4 pl-12">
                <p>
                  <span className="text-red-500 text-3xl">•</span> Do not buy a
